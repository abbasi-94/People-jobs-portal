...
import { saveJob, CATEGORIES, CATEGORY_LIST, JOB_TYPES, COUNTRIES } from '../lib/data';
import {
  Briefcase, CheckCircle, ArrowLeft, Globe, MapPin, DollarSign,
  Building2, Mail, FileText, ListChecks, Send,
} from 'lucide-react';
...
export default function PostJobPage() {
  ...
  const [form, setForm] = useState({
    title: '', company: '', location: '', country: 'Bahrain',
    category: 'Information Technology', subcategory: 'Software',
    type: 'Full-time', salary_min: '', salary_max: '',
    description: '', requirements: '', how_to_apply: '', employer_email: '',
  });
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button onClick={() => navigate('/jobs')} className="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-blue-700 transition-colors">View All Jobs</button>
            <button onClick={() => { setSubmitted(false); setForm({ title: '', company: '', location: '', country: 'Bahrain', category: 'Information Technology', subcategory: 'Software', type: 'Full-time', salary_min: '', salary_max: '', description: '', requirements: '', how_to_apply: '', employer_email: '' }); }}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6"><FileText className="w-5 h-5 text-blue-600" /><h2 className="font-semibold text-gray-900">Job Details</h2></div>
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" name="company" value={form.company} onChange={handleChange} required placeholder="e.g. TechCorp Inc."
          ...
          {/* Location */}
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6"><Globe className="w-5 h-5 text-blue-600" /><h2 className="font-semibold text-gray-900">Location</h2></div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select name="country" value={form.country} onChange={handleChange}
                    className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none">
          ...
          {/* Category & Type */}
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6"><ListChecks className="w-5 h-5 text-blue-600" /><h2 className="font-semibold text-gray-900">Category & Job Type</h2></div>
            <div className="space-y-5">
              <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {JOB_TYPES.map((t) => (
                    <label key={t}
                      className={`flex items-center gap-2 px-4 py-3 rounded-xl border cursor-pointer transition-all text-sm font-medium ${form.type === t ? 'bg-blue-50 border-blue-300 text-blue-700' : 'bg-gray-50 border-gray-200 text-gray-600 hover:bg-gray-100'}`}>
          ...
          {/* Salary */}
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6"><DollarSign className="w-5 h-5 text-blue-600" /><h2 className="font-semibold text-gray-900">Salary Range</h2></div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Minimum Salary</label>
                <input type="number" name="salary_min" value={form.salary_min} onChange={handleChange} placeholder="e.g. 4000"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Maximum Salary</label>
                <input type="number" name="salary_max" value={form.salary_max} onChange={handleChange} placeholder="e.g. 7000"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
              </div>
            </div>
          </div>
          ...
          {/* Description */}
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6"><FileText className="w-5 h-5 text-blue-600" /><h2 className="font-semibold text-gray-900">Job Description</h2></div>
          ...
          {/* Contact */}
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6"><Mail className="w-5 h-5 text-blue-600" /><h2 className="font-semibold text-gray-900">Contact Information</h2></div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Employer Email *</label>
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                <input type="email" name="employer_email" value={form.employer_email} onChange={handleChange} required placeholder="e.g. hr@company.com"
                  className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
              </div>
            </div>
          </div>

          <button type="submit" className="w-full bg-blue-600 text-white py-4 rounded-xl font-semibold text-sm hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 shadow-sm">
